            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap -mx-4">
                    <div className="mb-8 flex items-center lg:justify-center w-full md:w-1/2 lg:w-1/4 px-4">
                        <span className="mr-4 inline-block p-4 rounded bg-blue-100">
                            <svg className="w-6 h-6 text-blue-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
