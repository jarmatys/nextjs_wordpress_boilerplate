            ...
            <div className="py-20 bg-gray-50 radius-for-skewed">
                <div className="container mx-auto px-4">
                    <div className="mb-6 flex flex-wrap justify-center">
                            ...
                            <div className="mb-6 lg:mb-0 w-full lg:w-1/2 px-3">
                                <div className="h-full flex flex-col rounded shadow">
                                    ...
                                    <div className="mt-auto p-6 rounded-b bg-white">
                                        ...
                                        <p className="mb-6 text-gray-400 leading-loose">Quisque id sagittis turpis. Nulla sollicitudin rutrum eros eu dictum. Integer sit amet erat sit amet lectus lacinia mattis. Donec est tortor, fermentum at urna a, accumsan suscipit sem.</p>
                                        <a className="text-blue-600 hover:text-blue-700 font-bold" href="#">Learn More</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div><a className="inline-block py-2 px-6 rounded-l-xl rounded-t-xl bg-blue-600 hover:bg-blue-700 text-gray-50 font-bold leading-loose outline-none transition duration-200" href="#">View More Articles</a></div>
                    </div>
                </div>
            </div>
